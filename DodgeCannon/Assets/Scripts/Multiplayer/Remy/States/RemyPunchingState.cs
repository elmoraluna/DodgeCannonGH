...
public class RemyPunchingState : RemyState
{
    private Animator animator;
    private Rigidbody rb;
    private GameObject punchPosition;
    private float knockedDuration;
    public RemyPunchingState(RemyController controller, RemyStateMachine fsm) : base(controller, fsm)
    {
    ...
    private void Punch()
    {
        ...
        foreach (Collider collider in colliders)
        {
            ...
            {
                collider.GetComponent<JamesController>().Knocked(knockedDuration);
            }
        }
    }
}
